...
| Sat 22 Aug | **Builder — Hull v Man Utd (12:30), RESTRUCTURED after the app priced the correlated version at just 2.00:** Man Utd to win + Mbeumo to score or assist + McBurnie 2+ fouls committed (cross-dimension legs to dodge the correlation discount). Fallback if slip shows <3.00: Racing Post trio — Mbeumo score/assist + McBurnie 2+ fouls + Lammens 2+ saves @ ~9/2. **Lesson logged: bet365's builder engine crushes same-direction leg stacks; mix result/player/texture legs to keep the price.** | Bet builder | £10 | ≥3.0 → £30+ (fallback ~£55) | Mbeumo leg is sub-on-play-on so tonight placement is safe; voids if he doesn't feature. Place by 12:15 Sat. One bet on this game. |
| Sat 22 Aug | **Acca (3 legs):** Celtic to win at St Johnstone (~1.30) + Leverkusen to win at 3rd-tier Wehen Wiesbaden (~1.12, DFB-Pokal) + Frankfurt to win at 5th-tier FC St. Tönis (~1.05, DFB-Pokal). Class-gap legs only, no coin flips. Optional upgrade: if Leverkusen −1.5 is priced ≤1.45 in app, take it instead of the straight win. **L1/L2 sweep done:** only find was Leicester (in League One) home to Burton at 4/7 — optional swap for Frankfurt lifts return to ~£17 but drops the leg from 95% to ~64% (Leicester drew their opener); recommendation is keep the banker version. Rest of L1/L2 excluded (coin flips/low info). | Treble | £7.50 (trimmed to fit daily cap with longshot added) | ~1.53 straight (~£11.50) / ~£14 with the −1.5 upgrade / ~£17 with Leicester swap | Earliest KO is Leverkusen 12:00 UK — place by 11:45. Avoided: all four 3pm PL games (opening-day coin flips), Brentford v Spurs promo-only, Hull already in builder. |
| Sat 22 Aug | **Longshot treble (fun-money slot, new games only — no overlap with builder/acca):** Real Madrid −1 at Espanyol (~1.90) + Athletic Bilbao to beat Sevilla (~1.60) + West Ham −1 v Charlton (~2.20). Full-card sweep also covered Championship rd 2, La Liga rd 2, Supercup, Portugal — excluded Wolves/Boro away, WBA–Burnley, Valencia–Celta, Dortmund–Bayern, Eredivisie (evidence table). | Treble (handicaps) | £2.50 | ~8–10 → ~£20–25 | True probability ~12–15% — priced-in fun money, never more than £2.50. Place by 11:45 with the others. |
...
| Mon 24 Aug | Newcastle v Liverpool — research candidate with builder loss-insurance promo (up to £5 back if builder loses). Opt-in done in advance. | TBD | TBD | TBD | Research Monday; bet only if it clears the usual bar. |
