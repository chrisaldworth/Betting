...
| Sat 22 Aug | **Acca (3 legs, CORRECTED Saturday morning):** Leverkusen to win at Wehen Wiesbaden (~1.12, DFB-Pokal; −1.5 if ≤1.45) + Frankfurt to win at FC St. Tönis (~1.05, DFB-Pokal) + Leicester to win v Burton (4/7). **Celtic leg removed — fixture doesn't exist Saturday (postponed around the CL playoff; original fixture info was stale). Lesson: verify each acca leg exists in the app before finalising a slate — a fixture list from search is not a bet slip.** L1/L2 sweep's Leicester find became the replacement. | Treble | £7.50 | ~1.85 → ~£13.85 | Earliest KO Leverkusen 12:00 UK — place by 11:45. Avoided: 3pm PL coin flips, Brentford promo-only, Hull in builder. |
