...
| Structural trap-fades (2+ markers) work; single-marker fades don't | 3-for-3 (PSG, Villa-at-Hull 0-0, Spurs 0-0) vs 0-for-1 (Brugge, drought-only — Villa won 3-2) | Medium (n=4 with a control) — rule 6 v2 adopted 14 Sep |
| Hull's unbeaten/stingy start is under-priced by the market | Hull DC would-be won twice unbacked (0-0 v Villa, 2-2 at Chelsea); 0 league defeats, 2 goals conceded in 4 | Low (n=2, observational) — next Hull fixture gets a full workup |
| The morning value test can beat the closing line | Arsenal at Napoli: took 1.88, closed ~1.75 (+7% CLV), won. Brugge closed flat | Low (n=2 captures) — the metric that matters long-run; capture rate must improve |
| 4-fold stretch lines: higher raw would-be P/L, far worse risk profile | 11 days: 3-8 record, +£212.30 would-be vs card's +£42.20 — lead rests on 3 hits incl. legs money rules disallow; 5-day losing streaks | Low-medium — experiment continues on paper; rules 3/15 unchanged |
