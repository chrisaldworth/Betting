...
6. **Trap check before every bet:** is the favourite priced on reputation rather than current reality? (Rangers 4/11 while winless vs in-form St Mirren was the template trap. When market hesitation appears on a "banker" — like PSV at 1.60 — listen to it.) *(v2, 14 Sep 2026: a trap-FADE — actively backing against the reputation-priced side — may only be recommended when at least TWO structural markers are present: bottom-third table position; a 3+ game scoring/points drought; a named absence list hitting one department; or opponent H2H dominance. One marker alone is a watch note, not a bet. Basis: structural fades 3-for-3 (PSG, Villa-at-Hull, Spurs) vs 0-for-1 for the single-marker Brugge fade.)* *(v3, 21 Sep 2026: ADDITIONALLY the fade-PARTNER — the side we back or whose DC we take — must show at least ONE positive marker of its own: an unbeaten/points-scoring run, a top-half table position, or a banked result against an elite opponent. A fade against a broken favourite fails when the other side cannot punish. Basis: all three winning fades had a solid partner (Monaco top; Hull unbeaten; Everton unbeaten), while the Malaga loss (1-3 v Villarreal, 17 Sep) had a partner with eight absences, no wins and no such marker — the failure mode was the partner, not the markers on the faded side.)*
...
| Structural trap-fades (2+ markers) work — IF the fade-partner is solid | 3-for-3 with solid partners (PSG→Monaco, Villa→Hull, Spurs→Everton) vs 0-for-1 drought-only (Brugge) AND 0-for-1 with a broken partner (Malaga 1-3 Villarreal) | Medium (n=5, two controls) — rule 6 v3 adopted 21 Sep |
| Hull's unbeaten/stingy start is under-priced by the market — EXCEPT in revenge spots | Hull DC 2-for-3: won twice unbacked (draws v Villa, at Chelsea); lost when backed at a wounded favourite at home (Newcastle 2-1, post-Leeds-rout) | Low (n=3) — candidate filter: skip when the favourite is freshly humiliated and at home; watch, not yet a rule |
| The morning value test can beat the closing line — and CLV direction tracks results | Winners shortened (Arsenal 1.88→1.75; Monaco 2.05→1.91); losers drifted (Malaga, Hull) or closed flat (Brugge, Leeds 0-0). 6 captures, no counter-example yet of a DRIFTED winner | Low-medium (n=6) — drift-abort now a standing placement condition on every card (a placement practice, not a selection rule) |
| 4-fold stretch lines: higher raw would-be P/L, far worse risk profile | 18 days: 3-15 record, raw would-be +£132 and falling (lost 13 of last 15) vs card's steadier line — the lead rests on 3 early hits and shrinks by £10 most days | Medium — experiment continues on paper; rules 3/15 unchanged |
| Thesis-concentration declines keep being right | 12 Sep decline (Hull DC would have won) vs 19 Sep decline (Spurs-Villa builder would have LOST via U2.5) — 1-1 on outcomes, but both losses avoided correlated regime risk | Low (n=2) — rule kept |
| Est_prob may run ~2-3pts optimistic on near-miss losses | Malaga 0.60 (honest cap 0.55), Leeds 0.61 (honest 0.58) — both admitted same-day; Monaco 0.55 and Hull 0.48 looked fair | Low (n=4 week-4 bets) — week 5: write the est, subtract 2, re-check the value test still passes |
